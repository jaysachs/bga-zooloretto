...
ALTER TABLE `player` ADD COLUMN `money` INT UNSIGNED NOT NULL DEFAULT 0;
ALTER TABLE `player` ADD COLUMN `purchased_extensions` INT UNSIGNED NOT NULL DEFAULT 0;
ALTER TABLE `player` ADD COLUMN `truck_taken` INT UNSIGNED NOT NULL DEFAULT 0;
