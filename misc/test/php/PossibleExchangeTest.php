...
use Bga\Games\zooloretto\Model\{Enclosure, PositionSet, PossibleExchange, Tile, TileType};
...
final class PossibleExchangeTest extends TestCase
{
    ...
    private function pe(int $src_id, array $src_pos, int $dest_id, array $dest_pos): PossibleExchange {
        return new PossibleExchange(new PositionSet($src_id, $src_pos), new PositionSet($dest_id, $dest_pos));
    }
    ...
    public function testFullTest(): void {
        ...
        $encs[1]->placeTile(new Tile(7, TileType::CAMEL_MALE));
