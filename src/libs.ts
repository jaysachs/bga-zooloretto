import type { FloatingElementAnimationSettings, SlideAnimationSettings, BgaAnimations as BgaAnimationsType } from "./bga-animations";
...
export { BgaAnimations, BgaScoreSheet, SlideAnimationSettings, FloatingElementAnimationSettings };
